...
function Howitworks() {
  return (
    <div className='md:mt-40 mt-10 '>
      <h1 className="text-white text-2xl text-center title-font font-medium mb-4" style={{ textTransform: "capitalize" }}>How Its <span className='text-yellow-300'>Work</span></h1>
